...
class BaseModal(base.Modal):
  ...
  def __init__(self, driver):
    ...
    # todo: add proper class model for create, edit modals
    self.modal_type_lbl = base.Label(
        self._driver, locator.ModalCommonConfirmAction.MODAL_TITLE)
    ...
    self.code = (
        base.TextInputField(self._driver, self._locator_code) if
        self.is_create_modal
        else base.Label(self._driver, self._locator_code))
